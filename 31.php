...
$user = 'admin2'; // Ganti dengan nama pengguna yang Anda inginkan
$user_password = 'aasafasget%3535@Sjh'; // Ganti dengan kata sandi yang Anda inginkan
$email = 'email@gmail.com'; // Ganti dengan alamat email yang Anda inginkan
